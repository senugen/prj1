...
const isAdminPath = computed(() => currentPath.endsWith('/admin') || currentPath.includes('/admin/'));
const isSuccessPath = computed(() => currentPath.endsWith('/success') || currentPath.includes('/success/'));
